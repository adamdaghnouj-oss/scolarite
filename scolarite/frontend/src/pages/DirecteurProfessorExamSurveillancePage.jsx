    ...
    <div className="admin-wrap">
      <aside className="admin-sidebar">
        ...
        <nav className="admin-nav">
          ...
          <Link className="admin-nav-item" to="/directeur/prof-timetable">{tr("Timetable (professors)", "Emploi du temps (professeurs)")}</Link>
          <Link className="admin-nav-item admin-nav-item--active" to="/directeur/prof-exam-surveillance">{tr("Exam surveillance (professors)", "Surveillance examens (professeurs)")}</Link>
